...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Poppins:300,400,500&amp;subset=devanagari,latin-ext" rel="stylesheet">
                  ...
                  <div class="col-md-4 col-lg-6 col-sm-3 col-12">
                    <div class="jun__header__top__right">
                      <ul class="accounting d-flex justify-content-lg-end justify-content-md-end justify-content-start align-items-center">
                        <li><span style="color:#fff;">Contact Now : </span><a href="tel:+91 81297 76611">+91 81297 76611</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
